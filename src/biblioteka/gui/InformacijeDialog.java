...
public class InformacijeDialog extends JDialog {
	...
	public InformacijeDialog(Biblioteka biblioteka) {
		...
		contentPanel.add(BibliotekaNazivLabel, "cell 7 2,alignx left");
		
		JLabel AdresaLabel = new JLabel("Adresa:");
		AdresaLabel.setFont(new Font("Courier New", Font.BOLD, 18));
		contentPanel.add(AdresaLabel, "cell 6 3,alignx right");
		...
		contentPanel.add(BibliotekaAdresaLabel, "cell 7 3,alignx left");
		
		JLabel TelefonLabel = new JLabel("Broj telefona:");
		TelefonLabel.setFont(new Font("Courier New", Font.BOLD, 18));
		contentPanel.add(TelefonLabel, "cell 6 4,alignx right");
		...
		contentPanel.add(BibliotekaTelefonLabel, "cell 7 4,alignx left");
		
		JLabel VremeLabel = new JLabel("Radno vreme:");
		VremeLabel.setFont(new Font("Courier New", Font.BOLD, 18));
		contentPanel.add(VremeLabel, "cell 6 5,alignx right");
		...
		contentPanel.add(BibliotekaVremeLabel, "cell 7 5,alignx left");
	}
